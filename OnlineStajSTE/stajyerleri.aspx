									...
									<div class="row">
										<div class="col">
											<div class="post-meta">
												...
												<span><i class="far fa-user"></i> <a href="kullaniciprofili.aspx?ogrenci_id=<%#Eval("ogrenci_id") %>"> <asp:Label ID="Label2" runat="server" Text='<%#Eval("ogrenci_adi") %>'></asp:Label></a> </span>
