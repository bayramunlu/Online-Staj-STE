    ...
    <div id="examples" class="container py-2">
        <div class="row mt-3 pb-4">
							<div class="col text-center">
								...
								<p class="lead text-4 pt-2 font-weight-normal">Değerlendirme formlarına göre ilk 3 'e girmeyi başaran staj yerleri </p>
							</div>
						</div>
							...
							<div class="card flip-card text-center rounded-0">
								...
								<div class="flip-back d-flex align-items-center p-5" style="background-image: url(img/generic/generic-corporate-17-1.jpg); background-size: cover; background-position: center;">
									<div class="flip-content my-4">
										...
										<a href="staj-yeri-detay.aspx?firma_id=<%#Eval("firma_id") %>" class="btn btn-light btn-modern text-color-dark font-weight-bold">İncele</a>
									</div>
								</div>
							</div>
						</div>
