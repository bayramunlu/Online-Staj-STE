							...
							<div class="blog-posts single-post">
								...
								<article class="post post-large blog-single-post border-0 m-0 p-0">                                   
									...
									<div class="post-content ml-0">
										...
										<div class="post-meta">
											<span><i class="far fa-user"></i>  <a href="kullaniciprofili.aspx?ogrenci_id=<%#Eval("ogrenci_id") %>"><asp:Label ID="Label3" runat="server" Text='<%#Eval("ogrenci_adi") %>'></asp:Label></a> </span>
